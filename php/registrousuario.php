<?php
	...
	if (($cumple1== true) and ($cumple2== true)){
		$query31= "INSERT INTO usuarios (email, nombre, apellido, DNI,clave,tipo_usuario,suspendido,suscrito) values ('$_POST[user_mail]', '$_POST[nombre]', '$_POST[apellido]', '$_POST[dni]', '$_POST[clave]','pasajero','0','0')";//falta subir la imagen y su tipo
